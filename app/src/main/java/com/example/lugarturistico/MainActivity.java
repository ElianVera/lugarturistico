...
public class MainActivity extends AppCompatActivity {
    ...
    private ArrayList<Lugar> lugaresFiltrados = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lugares.add(new Lugar("Cafe & Tinto\n"+ "Fancy Mint \n" + "Sweet Land\n" +"Toro Café\n", "Alimentación y bebidas", "987654321\n"+"098315177\n"+"09877741359\n"+"986774419\n"));
        lugares.add(new Lugar("Ronda Quevedeña\n"+ "Iglesia San José\n" + "Igl.San Cristobal\n" +"Igl.SantTrinidad\n", "Actractivos Culturales", "987654321\n"+"0986774112\n"+"0986584763\n"+"098325726\n"));
        lugares.add(new Lugar("Boho Garden\n"+ "Coco Fresh\n" + "El Container\n" +"Paradise Resto Bar\n", "Esparcimiento", "0987411113\n"+"0986663215\n"+"0986554723\n"+"0935156778\n"));
        lugares.add(new Lugar("Boho Garden\n"+ "Coco Fresh\n" + "El Container\n" +"Paradise Resto Bar\n", "Compras", "0978895213\n"+"0986663215\n"+"0986554723\n"+"0935156778\n"));

        adapter = new LugarAdapter(lugaresFiltrados);
